...
const intro2El = intro2WrapEl.querySelector(".intro2");
...
function onload () {
    introLayoutEl.setAttribute("style", "animation: fade-in 0s 0.6s both;");
  setTimeout(function(){
    ...
    introLayoutEl.setAttribute("style", "animation: fade-out 1s 8s forwards;");
